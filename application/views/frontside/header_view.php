...
<html>
	<head>
		<title>www.abeiza.com</title>
		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<link href="<?php echo base_url();?>assets/css/bootstrap-responsive.css" rel="stylesheet">
		<link rel="stylesheet" href="<?php echo base_url();?>assets/css/base_style.css">
		...
		<div class="container-fluid">
			...
			<header>
				<div class="cd-dropdown-wrapper">
					<a class="cd-dropdown-trigger" href="#0"><i class="fa fa-list" style="margin-top:10px;font-size:18px;"></i></a>
					<nav class="cd-dropdown">
						...
						<ul class="cd-dropdown-content">
							...
							<li>
								<a href="<?php echo base_url();?>index.php/home/about">Profile</a>
							...
							<li>
								<a href="<?php echo base_url();?>index.php/home/portfolio">My Portfolio</a>
							...
							<!--<li class="cd-divider">Blog & Magazine</li>-->

							<li><a href="<?php echo base_url();?>index.php/home/resume">Resume</a></li>
							<li><a href="<?php echo base_url();?>index.php/home/blog">Blog & Magazine</a></li>
